...
const POSITION_CARDS: PositionCard[] = [
  ...
  },
  {
    ...
    description: 'Engineering systems like LinkLift, Nova & JARVIS — transforming complex user needs into high-performance software.',
    status: '● ACTIVE',
    statusColor: 'green',
    tags: ['LinkLift', 'Nova', 'JARVIS', 'Next.js 15', 'PostgreSQL'],
    icon: Rocket,
